...
def generate_video_from_image(image_path: str, output_path: str, num_frames: int = 25) -> str:
    """
    ...
    with autocast:
        frames = pipe(
            ...
            motion_bucket_id=127,  # Control motion amount (1-255, higher = more motion)
            fps=7,  # Frame rate
            noise_aug_strength=0.02,  # Add slight noise for better motion
        ).frames[0]
